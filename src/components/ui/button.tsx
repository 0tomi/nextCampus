...
const buttonVariants = cva('cursor-pointer', {
  variants: {
    variant: {
      primary:
        'rounded bg-white px-4 py-2 text-sm font-semibold text-black transition-opacity disabled:cursor-not-allowed disabled:opacity-50',
      ghost:
        'rounded border border-white/10 px-4 py-2 text-sm text-white/60 transition-colors hover:bg-white/5 hover:text-white',
    },
  },
})
