...
- Dependencias: Debe ser un único archivo. Podés importar hooks desde React. Solo podés usar las bibliotecas indicadas por el usuario o bibliotecas comunes y compatibles que se puedan renderizar de forma nativa en el navegador dentro de un iframe (por ejemplo, importándolas mediante CDNs o inyectando los scripts necesarios). No debe depender de archivos locales adicionales para funcionar.
