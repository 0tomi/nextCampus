...
- `Descripción corta`: resumen breve que se muestra en la campana.
- `Descripción completa`: texto completo que se muestra en la página de novedades.
...
- Si el `ID del changelog` ya existe, actualiza esa entrada con el nuevo nombre, descripción corta, descripción completa, rol objetivo y fecha de visibilidad.
...
Descripción completa: El campus suma una vista renovada para encontrar apuntes recientes con más claridad y menos pasos.
